...
export const ui = {
  en: {
    ...
    briefingPage: {
      ...
      deck:
        'A calm read on the most important Somali stories, active comparisons, and source signals Warka can verify today.',
      snapshot: 'Briefing snapshot',
      topStories: 'Top stories',
      activeClusters: 'Active clusters',
      developmentsTitle: 'Top developments',
      developmentsSubtitle: 'The stories most likely to shape the day, with original source links kept close.',
      clustersTitle: 'Active coverage clusters',
      clustersSubtitle: 'Developing events with multiple reports, source counts, language mix, and confidence signals.',
      changedKicker: 'Since yesterday',
      changedTitle: 'What changed since yesterday',
      changedMessage: '{count} newer reports arrived from {sources} sources in the last 24 hours.',
      noChangedMessage: 'Warka has not detected a fresh 24-hour change set yet. The current briefing is built from the latest available reports.',
      last24h: 'Last 24h',
      last48h: 'Last 48h',
      somaliaTitle: 'Somalia',
      regionalTitle: 'Horn and regional context',
      worldDiasporaTitle: 'World and diaspora',
      emptyTitle: 'The briefing is being prepared',
      emptyMessage: 'Warka could not load enough public story or comparison data yet. Free-tier hosting may need a moment to wake.',
    },
    sections: {
      topStories: 'Top Stories',
    ...
    sourceLens: {
      ...
      threePlus: '3+',
      fourPlus: '4+',
      clearFilters: 'Clear source lens',
    },
    share: {
      share: 'Share',
      copied: 'Copied',
      defaultText: 'Explore this Warka coverage comparison.',
      previewCard: 'Preview social card',
    },
    storyTrust: {
  ...
  so: {
    ...
    briefingPage: {
      kicker: 'War-kooban maalinle ah',
      title: 'War-koobka Soomaalida ee Maanta',
      deck:
        'Akhris deggan oo ku saabsan sheekooyinka Soomaalida ugu muhiimsan, isbarbardhigyada firfircoon, iyo calaamadaha ilaha ee Warka maanta xaqiijin karo.',
      snapshot: 'Sawirka war-koobka',
      topStories: 'Sheekooyinka muhiimka ah',
      activeClusters: 'Kooxo firfircoon',
      developmentsTitle: 'Horumarrada ugu muhiimsan',
      developmentsSubtitle: 'Sheekooyinka maanta saamaynta yeelan kara, iyadoo xiriirrada ilaha asalka ah muuqdaan.',
      clustersTitle: 'Kooxaha daboolidda firfircoon',
      clustersSubtitle: 'Dhacdooyin soo koraya oo leh warbixinno badan, tirada ilaha, luqadaha, iyo calaamadaha kalsoonida.',
      changedKicker: 'Tan iyo shalay',
      changedTitle: 'Waxa is beddelay tan iyo shalay',
      changedMessage: '{count} warbixin cusub ayaa ka timid {sources} ilo 24-kii saac ee u dambeeyay.',
      noChangedMessage: 'Warka weli ma helin isbeddel cusub oo 24-saac ah. War-koobkani waxa uu ku dhisan yahay warbixinnadii ugu dambeeyay ee la heli karo.',
      last24h: '24s u dambeeyay',
      last48h: '48s u dambeeyay',
      somaliaTitle: 'Soomaaliya',
      regionalTitle: 'Geeska iyo gobolka',
      worldDiasporaTitle: 'Caalamka iyo qurbajoogta',
      emptyTitle: 'War-koobka waa la diyaarinayaa',
      emptyMessage: 'Warka weli ma soo qaadi karo xog ku filan oo sheekooyin ama isbarbardhigyo dadweyne ah. Martigelinta free-tier waxay u baahan kartaa daqiiqad.',
    },
    sections: {
    ...
    coverageHub: {
      ...
      firstReported: 'Markii ugu horreysay',
      latestReport: 'Warbixintii ugu dambaysay',
      latestUpdate: 'Cusboonaysiintii ugu dambaysay',
      relatedReport: 'Warbixin la xiriirta',
      sourceLanguage: 'Luqadda isha',
      sourceType: 'Nooca isha',
      publishedAt: 'La daabacay',
      unknownDate: 'Taariikh lama diiwaangelin',
      unknownTime: 'Waqti lama hayo',
    ...
    sourceLens: {
      coverageTopic: 'Mawduuca daboolidda',
      all: 'Dhammaan',
      language: 'Luqadda',
      sourceCategory: 'Nooca isha',
      confidence: 'Kalsooni',
      recency: 'Cusboonaysiin',
      sourceCount: 'Tirada ilaha',
      news: 'Warar',
      international: 'Caalami',
      humanitarian: 'Bini’aadannimo',
      diaspora: 'Qurbajoog',
      high: 'Sare',
      medium: 'Dhexe',
      low: 'Hoose',
      ...
      threePlus: '3+',
      fourPlus: '4+',
      clearFilters: 'Nadiifi muraayadda ilaha',
    },
    share: {
      share: 'Wadaag',
      copied: 'La koobiyay',
      defaultText: 'Baadh isbarbardhigga daboolidda ee Warka.',
      previewCard: 'Arag kaarka wadaagga',
    },
    storyTrust: {
